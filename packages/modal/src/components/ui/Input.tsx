const labelClasses = 'font-semibold text-gray-700 text-xs uppercase tracking-wide';
const inputClasses =
...
export const Input = ({ id, value, placeholder, ariaLabel, readOnly = true }: InputProps) => (
	<input
		id={id}
...
export const InputGroup = ({ label, values, placeholder, inputIdPrefix }: InputGroupProps) => (
