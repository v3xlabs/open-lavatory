 ...
 */
export async function waitForOpenLVProvider(page: Page, timeout = 10000): Promise<boolean> {
    try {
        await page.waitForFunction(() => typeof (window as any).openlv !== 'undefined', {
            timeout,
        });
 ...
 */
export async function testEIP6963Discovery(page: Page): Promise<EIP6963DiscoveryResult> {
    return await page.evaluate(() => {
