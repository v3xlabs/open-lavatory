...
/**
 * Resolves the actual theme mode to apply.
 *
 * @param appThemeMode - The mode set by the developer in ThemeConfig (defaults to "auto")
 * @param userTheme - The user's stored preference (only used when appThemeMode is "auto")
 */
